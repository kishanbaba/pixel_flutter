...
//
//     final projectReponseModel = projectReponseModelFromJson(jsonString);

import 'dart:convert';

FinishedProjectResponseModel finishedProjectResponseModelFromJson(String str) =>
    FinishedProjectResponseModel.fromJson(json.decode(str));

String projectResponseModelToJson(FinishedProjectResponseModel data) =>
    json.encode(data.toJson());

class FinishedProjectResponseModel {
  FinishedProjectResponseModel({
    this.statusCode,
    this.status,
    this.message,
    this.data,
  ...
  factory FinishedProjectResponseModel.fromJson(Map<String, dynamic> json) =>
      FinishedProjectResponseModel(
