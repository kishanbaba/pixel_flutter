...
PendingProjectResponseModel pendingProjectResponseModelFromJson(String str) =>
    PendingProjectResponseModel.fromJson(json.decode(str));

String pendingProjectResponseModelToJson(PendingProjectResponseModel data) =>
    json.encode(data.toJson());

class PendingProjectResponseModel {
  PendingProjectResponseModel({
    this.statusCode,
    this.status,
    this.message,
    this.data,
  ...
  factory PendingProjectResponseModel.fromJson(Map<String, dynamic> json) =>
      PendingProjectResponseModel(
