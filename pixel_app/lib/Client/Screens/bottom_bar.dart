...
import 'package:pixel_app/Client/Screens/change_password.dart';
import 'package:pixel_app/Client/Screens/client_profile_screen.dart';
import 'package:pixel_app/Client/Screens/dashboard_screen.dart';
import 'package:pixel_app/Client/Screens/office_close_day_screen.dart';
import 'package:pixel_app/Client/Screens/payment_screen.dart';
import 'package:pixel_app/Client/Screens/project_screen.dart';
import 'package:pixel_app/Client/Screens/same_day_screen.dart';
import 'package:pixel_app/Client/ViewModel/client_delete_view_model.dart';
...
class _BottomBarScreenState extends State<BottomBarScreen> {
  ...
  ClientDeleteViewModel clientDeleteViewModel =
      Get.put(ClientDeleteViewModel());
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            ...
                            child: Text(
                                '${PreferenceManager.getClientCode().split('').first}',
                                style: TextStyle(
                                    fontFamily: 'Roboto',
                                    fontSize: 25,
                                    fontWeight: FontWeight.w500,
                          ...
                          Container(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  // '',
                                  '(${PreferenceManager.getClientCode()})${PreferenceManager.getCompanyName()}',
                                  style: TextStyle(
                                      fontFamily: 'Roboto',
                                      fontSize: 16,
                                      fontWeight: FontWeight.w500,
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 20),
                      GetBuilder<ClientDeleteViewModel>(
                        builder: (controller) {
                          return InkWell(
                            onTap: () async {
                              showDialog(
          ...
          child: RollingBottomBar(
            ...
            items: const [
              RollingBottomBarItem(Icons.grid_view,
                  label: 'Dashbord', activeColor: Colors.white),
              ...
              RollingBottomBarItem(Icons.calendar_month,
                  label: 'S-Day', activeColor: Colors.white),
              RollingBottomBarItem(Icons.payment,
                  label: 'Payment', activeColor: Colors.white),
              RollingBottomBarItem(Icons.calendar_month,
