...
EmployeePendingProjectResponseModel employeePendingProjectResponseModelFromJson(
        String str) =>
    EmployeePendingProjectResponseModel.fromJson(json.decode(str));

String employeePendingProjectResponseModelToJson(
        EmployeePendingProjectResponseModel data) =>
    json.encode(data.toJson());

class EmployeePendingProjectResponseModel {
  EmployeePendingProjectResponseModel({
    this.statusCode,
    this.status,
    this.message,
    this.data,
  ...
  factory EmployeePendingProjectResponseModel.fromJson(
